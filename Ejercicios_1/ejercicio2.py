...
class Ventana(QWidget):
    def __init__(self):
        ...
        layout.addWidget(self.label_email,0, 0, alignment=Qt.AlignmentFlag.AlignLeft)
        layout.addWidget(self.input_email,0, 1)

        layout.addWidget(self.label_pass, 1, 0, alignment = Qt.AlignmentFlag.AlignRight)
        layout.addWidget(self.input_pass, 1, 1)

        layout.addWidget(self.boton_login, 2, 0, 1, 2, alignment=Qt.AlignmentFlag.AlignCenter)
